...
### Announcements
- Learning/Studying for the Code Challenge
 	- Practice Challenges for deployed (Sushi Saga and Pokemon Searcher)
	- Watch "React from Scratch" Videos Ann will slack out
	- Build your own React App using create-react-app :D
- Mod 4 Projects and Partners
